...
public class CartServiceImpl implements ICartService {
    ...
    public ServerResponse add(Integer userId, Integer productId, Integer count) {
        ...
        return ServerResponse.serverResponsebBySuccess(cartVO);
    }
    ...
    public ServerResponse update(Integer userId, Integer productId, Integer count) {
        ...
        //step4：返回cartvo
        return ServerResponse.serverResponsebBySuccess(getCartVOLimit(userId));
    ...
    public ServerResponse get_cart_product_count(Integer userId) {
        ...
        return ServerResponse.serverResponsebBySuccess(quantity);
    ...
    private CartVO getCartVOLimit(Integer userId){
        ...
        if(cartList != null && cartList.size()>0){
            for(Cart cart : cartList){
                ...
                if(cartProductVO.getProductChecked() == Const.CartCheckEnum.PRODUCT_CHECKED.getCode()){  //被选中，计算总价
